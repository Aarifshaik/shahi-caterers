...
var ee,
  ...
  Oe = e(() => {
    ((ee = Object.create),
      ...
      (ce = (e, t, n) =>
        t in e ? te(e, t, { enumerable: !0, configurable: !0, writable: !0, value: n }) : (e[t] = n)),
      ...
      (fe = (e, t, n, r) => {
        if ((t && typeof t == `object`) || typeof t == `function`)
          for (let i of re(t))
            !ae.call(e, i) && i !== n && te(e, i, { get: () => t[i], enumerable: !(r = ne(t, i)) || r.enumerable });
        return e;
      }),
      (pe = (e, t, n) => (
        (n = e == null ? {} : ee(ie(e))),
        fe(t || !e || !e.__esModule ? te(n, `default`, { value: e, enumerable: !0 }) : n, e)
      )),
      ...
      (be = (e, t, n, r, i, a) => {
        ...
        for (var y = r.length - 1; y >= 0; y--)
          ((l = _e(d, n, (c = {}), e[3], _)),
            ...
            (s = (0, r[y])(d ? (d < 4 ? (p ? a : v[h]) : d > 4 ? void 0 : { get: v.get, set: v.set }) : i, l)),
            (c._ = 1),
            d ^ 4 || s === void 0
              ? ge(s) && (d > 4 ? g.unshift(s) : d ? (p ? (a = s) : (v[h] = s)) : (i = s))
              : typeof s != `object` || !s
                ? se(`Object expected`)
                : (ge((o = s.get)) && (v.get = o), ge((o = s.set)) && (v.set = o), ge((o = s.init)) && g.unshift(o)));
      ...
      (Te = (e, t, n) =>
        t.has(e)
          ...
          : t instanceof WeakSet
            ? t.add(e)
            : t.set(e, n)),
      (Ee = (e, t, n, r) => (Se(e, t, `write to private field`), r ? r.call(e, n) : t.set(e, n), n)),
...
function Ze(e) {
  let t = _c(e);
  if ((os(!!t, `'${e}' is not an animatable color. Use the equivalent color code instead.`), !t)) return !1;
  let n = t.parse(e);
...
function it(e, t, n) {
  if (typeof e == `number` && typeof t == `number` && typeof n == `number`) return q(e, t, n);
  let r = et(e);
  return r(e, t);
}
function at(e) {
...
function gt(e, t, { clamp: n = !0, ease: r, mixer: i } = {}) {
  let a = e.length;
  if ((M(a === t.length, `Both input and output ranges must be the same length`), a === 1)) return () => t[0];
...
function Ht(e) {
  ...
  return (
    dl() && r && ul.has(r) && (r !== `transform` || !l) && !c && !i && a !== `mirror` && o !== 0 && s !== `inertia`
  );
}
function Ut(e) {
  let t = e[0];
...
function Yt(e, t) {
  let n = jl(e);
  return (n !== kl && (n = K), n.getAnimatableNone ? n.getAnimatableNone(t) : void 0);
}
function Xt(e) {
...
function Zt(e, t, n) {
  ...
  for (; r < e.length && !i; ) {
    let t = e[r];
    (typeof t == `string` && !Ml.has(t) && We(t).values.length && (i = e[r]), r++);
  }
...
function ln(e, t, n = {}) {
  let [r, i, a] = tn(e, n),
    o = (e) => {
      ...
      (S.addEventListener(`pointerup`, s, i), S.addEventListener(`pointercancel`, c, i));
    };
  return (
    r.forEach((e) => {
      ...
      (t.addEventListener(`pointerdown`, o, i),
        Vt(e) &&
          (e.addEventListener(`focus`, (e) => ql(e, i)), !an(e) && !e.hasAttribute(`tabindex`) && (e.tabIndex = 0)));
    }),
    a
  );
}
...
function gn(e) {
  return (
    ...
    eu || hn(),
    () => {
      ($l.delete(e), !$l.size && typeof eu == `function` && (S.removeEventListener(`resize`, eu), (eu = void 0)));
    }
  );
}
function _n(e, t) {
...
function xn(e, t, n) {
  ...
  e.attach((t, n) => ((a = t), (o = (e) => n(Sn(e, s))), R.postRender(l), e.get()), c);
  let u;
  return (X(t) && ((u = t.on(`change`, (t) => e.set(Sn(t, s)))), e.on(`destroy`, u)), u);
}
function Sn(e, t) {
  return t ? e + t : e;
}
...
function Bn(e, t) {
  if (Rn(e)) {
    ...
    return { initial: t === !1 || Ln(t) ? t : void 0, animate: Ln(n) ? n : void 0 };
  }
...
function Jn({ preloadedFeatures: e, createVisualElement: t, useRender: n, useVisualState: r, Component: a }) {
  ...
  function o(i, o) {
    ...
    if (!l && ts) {
      Xn(c, e);
      let n = Zn(c);
      ((s = n.MeasureLayout), (u.visualElement = Gn(a, d, c, t, n.ProjectionNode)));
    }
    return b(vu.Provider, {
      value: u,
      children: [
        s && u.visualElement ? m(s, { visualElement: u.visualElement, ...c }) : null,
...
function $n(e, t, n) {
  ...
  for (let a = 0; a < Ou; a++) {
    ...
    let c = !0;
    if (((c = typeof s == `number` ? s === (o.startsWith(`scale`) ? 1 : 0) : parseFloat(s) === 0), !c || n)) {
      let e = Fl(s, El[o]);
      if (!c) {
        i = !1;
        let t = Du[o] || o;
...
function ar(e) {
  ...
  let t = new Map(),
    n = (...t) => e(...t);
  return new Proxy(n, { get: (n, r) => (r === `create` ? e : (t.has(r) || t.set(r, e(r)), t.get(r))) });
}
...
function sr(e, t, n) {
  ...
  if ((t.transform || (o || n ? (r.transform = $n(t, e.transform, n)) : (r.transform &&= `none`)), s)) {
...
function mr(e, t, n, r) {
  let i = v(() => {
    let n = Nu();
    return (pr(n, t, Pu(r), e.transformTemplate, e.style), { ...n.attrs, style: { ...n.style } });
  }, [t]);
  if (e.style) {
    let t = {};
...
function yr(e, t) {
  return function (n, { forwardMotionProps: r } = { forwardMotionProps: !1 }) {
    let i = hr(n) ? Lu : Iu,
      a = { ...i, preloadedFeatures: e, useRender: gr(r), createVisualElement: t, Component: n };
    return Jn(a);
  };
}
function br(e, t, n) {
...
function Ar(e, t, { delay: n = 0, transitionOverride: r, type: i } = {}) {
  ...
  for (let t in s) {
    ...
    (Tr(e, t), r.start(Gu(t, r, i, e.shouldReduceMotion && yl.has(t) ? { type: !1 } : o, e, d)));
    let f = r.animation;
    f && c.push(f);
  }
  return (
    ...
    Array.from(e.variantChildren)
      ...
      .forEach((e, r) => {
        (e.notify(`AnimationStart`, t),
          o.push(jr(e, t, { ...a, delay: n + c(r) }).then(() => e.notify(`AnimationComplete`, t))));
      }),
    Promise.all(o)
  );
}
...
function Rr(e) {
  ...
  function o(a) {
    ...
    for (let t = 0; t < Ju; t++) {
      ...
      let ee = _ && v,
        te = !ee || b;
      y && te && c.push(...x.map((e) => ({ animation: e, options: { type: f } })));
    }
    if (l.size) {
      let t = {};
...
function pi(e, { x: t, y: n }) {
  (fi(e.x, t.translate, t.scale, t.originPoint), fi(e.y, n.translate, n.scale, n.originPoint));
}
...
function Si({ point: e }, t) {
  return { point: e, delta: xi(e, wi(t)), offset: xi(e, Ci(t)), velocity: Ti(t, 0.1) };
}
function Ci(e) {
  return e[0];
}
...
function ji(e, t) {
  let n = 0.5,
    r = O(e),
    i = O(t);
  return (i > r ? (n = ds(t.min, t.max - r, e.min)) : r > i && (n = ds(e.min, e.max - i, t.min)), j(0, 1, n));
}
function Mi(e, t) {
  let n = {};
...
function Ni(e = xd) {
  return (e === !1 ? (e = 0) : e === !0 && (e = xd), { x: Pi(e, `left`, `right`), y: Pi(e, `top`, `bottom`) });
}
function Pi(e, t, n) {
...
function zi(e) {
  let [t, n] = wn(),
    r = _(es);
  return m(Ad, { ...e, layoutGroup: r, switchLayoutGroup: _(Su), isPresent: t, safeToRemove: n });
}
function Bi(e, t, n) {
  let r = X(e) ? e : E(e);
...
function Vi(e, t, n, r, i, a) {
  ...
  for (let i = 0; i < Nd; i++) {
    ...
    c ? ((e[a] = Math.max(q(Pd(o), Pd(s), r), 0)), (U.test(s) || U.test(o)) && (e[a] += `%`)) : (e[a] = s);
  }
...
function Ki(e, t, n, r, i) {
  return ((e -= t), (e = ui(e, 1 / n, r)), i !== void 0 && (e = ui(e, 1 / i, r)), e);
}
function qi(e, t = 0, n = 1, r = 0.5, i, a = e, o = e) {
  ...
  (e === a && (s -= t), (e.min = Ki(e.min, t, n, s, i)), (e.max = Ki(e.max, t, n, s, i)));
}
function Ji(e, t, [n, r, i], a, o) {
  qi(e, t[n], t[r], t[i], t.scale, a, o);
}
function Yi(e, t, n, r) {
  (Ji(e.x, t, Rd, n ? n.x : void 0, r ? r.x : void 0), Ji(e.y, t, zd, n ? n.y : void 0, r ? r.y : void 0));
}
function Xi(e) {
...
function sa({ attachResizeListener: e, defaultParent: t, measureScroll: n, checkIsScrollRoot: r, resetTransform: i }) {
  return class {
    ...
    addEventListener(e, t) {
      return (this.eventHandlers.has(e) || this.eventHandlers.set(e, new fs()), this.eventHandlers.get(e).add(t));
    }
    notifyListeners(e, ...t) {
      ...
      if (
        ...
        e(t, () => {
          ((this.root.updateBlockedByResize = !0),
            n && n(),
            (n = $r(r, 250)),
            Dd.hasAnimatedSinceResize && ((Dd.hasAnimatedSinceResize = !1), this.nodes.forEach(ga)));
        });
      }
        ...
        this.options.animate !== !1 &&
          ...
          this.addEventListener(
            ...
            ({ delta: e, hasLayoutChanged: t, hasRelativeLayoutChanged: n, layout: r }) => {
              ...
              } else (t || ga(this), this.isLead() && this.options.onExitComplete && this.options.onExitComplete());
              this.targetLayout = r;
            },
          ));
    }
    ...
    startUpdate() {
      this.isUpdateBlocked() || ((this.isUpdating = !0), this.nodes && this.nodes.forEach(ya), this.animationId++);
    }
    ...
    willUpdate(e = !0) {
      ...
      if (
        (S.MotionCancelOptimisedAnimation && !this.hasCheckedOptimisedAppear && oa(this),
    ...
    removeElementScroll(e) {
      ...
      for (let t = 0; t < this.path.length; t++) {
        ...
        r !== this.root && i && a.layoutScroll && (i.wasRoot && A(n, e), hi(n.x, i.offset.x), hi(n.y, i.offset.y));
      }
      return n;
    }
    ...
    removeTransform(e) {
      ...
      for (let e = 0; e < this.path.length; e++) {
        ...
        let r = $(),
          i = n.measurePageBox();
        (A(r, i), Yi(t, n.latestValues, n.snapshot ? n.snapshot.layoutBox : void 0, r));
      }
    ...
    resolveTargetDelta(e = !1) {
      ...
      if (!(!this.layout || !(a || o))) {
        ...
        if (!(!this.relativeTarget && !this.targetDelta)) {
          if (
            (this.target || ((this.target = $()), (this.targetWithTransforms = $())),
    ...
    calcProjection() {
      ...
      let t = this.getLead(),
        ...
        r = !0;
      if (
        ((this.isProjectionDirty || (e = this.parent)?.isProjectionDirty) && (r = !1),
    ...
    createProjectionDeltas() {
      ((this.prevProjectionDelta = sd()), (this.projectionDelta = sd()), (this.projectionDeltaWithTransform = sd()));
    }
    setAnimationOrigin(e, t = !1) {
      ...
      ((this.mixTargetDelta = (t) => {
        ...
        (xa(a.x, e.x, n),
          ...
          l && ((this.animationValues = i), Vi(i, r, this.latestValues, n, f, d)),
        ...
        (this.pendingAnimation = R.update(() => {
          ((Dd.hasAnimatedSinceResize = !0),
            ...
            (this.currentAnimation = Bi(this.motionValue, [0, 1e3], {
              ...
              onComplete: () => {
                (Rs.layout--, e.onComplete && e.onComplete(), this.completeAnimation());
              },
            })),
    ...
    finishAnimation() {
      (this.currentAnimation && (this.mixTargetDelta && this.mixTargetDelta(Wd), this.currentAnimation.stop()),
    ...
    applyTransformsToTarget() {
      ...
      if (!(!t || !n || !r)) {
        ...
        (A(t, n), _i(t, i), qr(this.projectionDeltaWithTransform, this.layoutCorrected, t, i));
      }
    }
    ...
    resetSkewAndRotation() {
      ...
      for (let t = 0; t < Hd.length; t++)
        (aa(`rotate${Hd[t]}`, e, r, this.animationValues), aa(`skew${Hd[t]}`, e, r, this.animationValues));
    ...
    getProjectionStyles(e) {
        ...
        ? (t.opacity =
            r === this
              ...
              : this.preserveOpacity
                ...
                : i.opacityExit)
        : (t.opacity =
            r === this ? (i.opacity === void 0 ? `` : i.opacity) : i.opacityExit === void 0 ? 0 : i.opacityExit),
      Eu)) {
      ...
      return (this.options.layoutId && (t.pointerEvents = r === this ? er(e?.pointerEvents) || `` : `none`), t);
    }
    clearSnapshot() {
    ...
    if (!e.resumeFrom) {
      ...
      if (r && !r.resumeFrom) {
        ...
        if (i && a) {
          ...
          (Zr(s, t, a.layoutBox),
            ta(o, s) || (l = !0),
            r.options.layoutRoot && ((e.relativeTarget = s), (e.relativeTargetOrigin = o), (e.relativeParent = r)));
        }
      }
    }
...
function Da(e, t, n) {
  return e === `position` || (e === `preserve-aspect` && !Gr(na(t), na(n), 0.2));
}
function Oa(e) {
  var t;
...
function Ia(e, t, n, r) {
  for (let n in (Pa(e, t, void 0, r), t.attrs)) e.setAttribute(mf.has(n) ? n : yu(n), t.attrs[n]);
}
function La(e, t, n, r) {
  let i = n[t],
...
function za(e, t) {
  let n = { x: 0, y: 0 },
    r = e;
  for (; r && r !== t; )
    if (Vt(r)) ((n.x += r.offsetLeft), (n.y += r.offsetTop), (r = r.offsetParent));
...
function Va(e, t, n, r) {
  ...
  return (
    typeof e == `number`
      ? (i = [e, e])
      : typeof e == `string` && ((e = e.trim()), (i = e.includes(` `) ? e.split(` `) : [e, Ef[e] ? e : `0`])),
    (a = Ba(i[0], n, r)),
    (o = Ba(i[1], t)),
    a - o
  );
...
function Ua(e, t, n) {
  ...
  (u && ((t[a].interpolate = gt(t[a].offset, vt(r), { clamp: !1 })), (t[a].interpolatorOffsets = [...t[a].offset])),
...
function Ka(e, { container: t = document.scrollingElement, ...n } = {}) {
  ...
  return (
    ...
    () => {
      ...
      (Af.delete(t),
        r &&
          (Nf(t).removeEventListener(`scroll`, r), (e = jf.get(t)) == null || e(), S.removeEventListener(`resize`, r)));
    }
  );
}
function qa(e) {
...
function Ja({ source: e, container: t, ...n }) {
  ...
  let a = n.target ?? `self`,
    ...
    s = r + (n.offset ?? []).join(`,`);
  return (
    o[s] || (o[s] = !n.target && tl() ? new ScrollTimeline({ source: t, axis: r }) : qa({ container: t, ...n })),
    o[s]
  );
}
function Ya(e, t) {
    ...
    let g = 0,
      _ = (e, n, r, o = 0, s = 0) => {
        ...
        if ((T > 0 && _t(u, T), c.length === 1 && c.unshift(null), m)) {
          (M(m < Rf, `Repeat count too high, must be less than 20`), (b = go(b, m)));
          let e = [...c],
            t = [...u];
          ...
          for (let r = 0; r < m; r++) {
            c.push(...e);
            for (let i = 0; i < e.length; i++) (u.push(t[i] + (r + 1)), y.push(i === 0 ? `linear` : Le(n, i - 1)));
          }
          bo(u, m);
        }
        let ee = w + b;
...
function Vo(e, t, { root: n, margin: r, amount: i = `some` } = {}) {
  let a = Qt(e),
    ...
    c = new IntersectionObserver(s, { root: n, rootMargin: r, threshold: typeof i == `number` ? i : Wf[i] });
...
function Go({ children: e, as: t = `ul`, axis: n = `y`, onReorder: r, values: i, ...a }, o) {
  ...
  let u = {
    ...
    registerItem: (e, t) => {
      ...
      (r === -1 ? c.push({ value: e, layout: t[n] }) : (c[r].layout = t[n]), c.sort(qo));
    },
    updateOrder: (e, t, n) => {
      if (l.current) return;
      let a = Wo(c, e, t, n);
      c !== a && ((l.current = !0), r(a.map(Ko).filter((e) => i.indexOf(e) !== -1)));
    },
  };
  return (
    x(() => {
    ...
    m(s, { ...a, ref: o, ignoreStrict: !0, children: m(Jf.Provider, { value: u, children: e }) })
  );
}
function Ko(e) {
  return e.value;
...
var Qo,
  ...
  Zf = e(() => {
    ...
    (bs = vs(ys)),
    (xs = _s(bs)),
    (Ss = (e) => ((e *= 2) < 1 ? 0.5 * bs(e) : 0.5 * (2 - 2 ** (-10 * (e - 1))))),
    ...
    (Ns = (e) => {
      if (As(e)) {
        ...
        let [t, n, r, i] = e;
        return Ie(t, n, r, i);
      } else if (Ms(e)) return (M(js[e] !== void 0, `Invalid easing type '${e}'`), js[e]);
      return e;
    }),
    ...
    (V = {
      now: () => (Ls === void 0 && V.set(B.isProcessing || N.useManualTiming ? B.timestamp : performance.now()), Ls),
      set: (e) => {
    ...
    (Ws = { test: (e) => typeof e == `number`, parse: parseFloat, transform: (e) => e }),
    ...
    (ec = {
      ...
      transform: ({ red: e, green: t, blue: n, alpha: r = 1 }) =>
        `rgba(` + $s.transform(e) + `, ` + $s.transform(t) + `, ` + $s.transform(n) + `, ` + qs(Gs.transform(r)) + `)`,
    }),
    ...
    (rc = nc(`vh`)),
    (ic = nc(`vw`)),
    (ac = (() => ({ ...U, parse: (e) => U.parse(e) / 100, transform: (e) => U.transform(e * 100) }))()),
    (oc = {
      test: Xs(`hsl`, `hue`),
    ...
    (Nc = class extends jc {
        ...
        (super(),
          ...
          (this.stop = () => {
            ...
            (n && n.updatedAt !== V.now() && this.tick(V.now()),
              (this.isStopped = !0),
              this.state !== `idle` && (this.teardown(), (t = (e = this.options).onStop) == null || t.call(e)));
          }),
          Rs.mainThread++,
          (this.options = e),
          this.initAnimation(),
      ...
      initAnimation() {
        ...
        let { type: t = xt, repeat: n = 0, repeatDelay: r = 0, repeatType: i, velocity: a = 0 } = e,
          { keyframes: o } = e,
          s = t || xt;
        s !== xt && typeof o[0] != `number` && ((this.mixKeyframes = us(Mc, it(o[0], o[1]))), (o = [0, 100]));
      ...
      tick(e, t = !1) {
        ...
        if (u) {
          ...
          let i = !!(t % 2);
          (i && (d === `reverse` ? ((n = 1 - n), f && (n -= f / o)) : d === `mirror` && (y = a)), (v = j(0, 1, n) * o));
        }
      ...
      play() {
        ...
        ((this.driver ||= n((e) => this.tick(e))), (t = (e = this.options).onPlay) == null || t.call(e));
      ...
      teardown() {
        ((this.state = `idle`), this.stopDriver(), (this.startTime = this.holdTime = null), Rs.mainThread--);
      }
      stopDriver() {
    ...
    ($c = class {
      ...
      scheduleResolve() {
        ((this.state = `scheduled`),
          this.isAsync
            ? (Yc.add(this), Xc || ((Xc = !0), R.read(jt), R.resolveKeyframes(At)))
      ...
      measureEndState() {}
      complete(e = !1) {
        ((this.state = `complete`), this.onComplete(this.unresolvedKeyframes, this.finalKeyframe, e), Yc.delete(this));
      }
      cancel() {
    ...
    (ol = class extends jc {
        ...
        ((this.animation = It(t, n, r, c, i)),
          ...
          (this.animation.onfinish = () => {
            if (((this.finishedTime = this.time), !i)) {
              ...
              (this.updateMotionValue ? this.updateMotionValue(e) : Nt(t, n, e), this.animation.cancel());
            }
      ...
      attachTimeline({ timeline: e, observe: t }) {
        var n;
        return (
          this.allowFlatten && ((n = this.animation.effect) == null || n.updateTiming({ easing: `linear` })),
    ...
    (ll = class extends ol {
      constructor(e) {
        (Bt(e), Ct(e), super(e), e.startTime && (this.startTime = e.startTime), (this.options = e));
      }
      updateMotionValue(e) {
        ...
        (t.setWithVelocity(o.sample(s - cl).value, o.sample(s).value, cl), o.stop());
      }
    }),
    ...
    (ml = class extends jc {
      constructor({
        ...
        (super(),
          (this.stop = () => {
            var e, t;
            (this._animation && (this._animation.stop(), (e = this.stopTimeline) == null || e.call(this)),
      ...
      onKeyframesResolved(e, t, n, r) {
        ...
        let u = r
          ...
          f = !c && Ht(d) ? new ll({ ...d, element: d.motionValue.owner.current }) : new Nc(d);
        (f.finished.then(() => this.notifyFinished()).catch(P),
          (this.pendingTimeline &&= ((this.stopTimeline = f.attachTimeline(this.pendingTimeline)), void 0)),
          (this._animation = f));
      }
      get finished() {
      ...
      get animation() {
        var e;
        return (this._animation || ((e = this.keyframeResolver) == null || e.resume(), Mt()), this._animation);
      }
      get duration() {
    ...
    (Nl = class extends $c {
      ...
      resolveNoneKeyframes() {
        let { unresolvedKeyframes: e, name: t } = this,
          n = [];
        for (let t = 0; t < e.length; t++) (e[t] === null || Xt(e[t])) && n.push(t);
        n.length && Zt(e, n, t);
      }
      measureInitialState() {
    ...
    (zl = class {
          ...
          (this.updateAndNotify = (e, t = !0) => {
            ...
            if (
              ...
              this.current !== this.prev &&
                ((n = this.events.change) == null || n.notify(this.current), this.dependents))
            )
      ...
      getVelocity() {
        let e = V.now();
        if (!this.canTrackVelocity || this.prevFrameValue === void 0 || e - this.updatedAt > Il) return 0;
    ...
    (Z = T({ transformPagePoint: (e) => e, isStatic: !1, reducedMotion: `never` })),
    (iu = class extends n {
    ...
    (au = ({
      ...
      return (
        ...
        s === `popLayout` && (e = m(Tn, { isPresent: n, anchorX: c, children: e })),
    ...
    (fu = ({ children: e, id: t, inherit: n = !0 }) => {
      let r = _(es),
        ...
        c = r.id || i;
      s.current === null &&
        (du(n) && c && (t = t ? c + `-` + t : c), (s.current = { id: t, group: (uu(n) && r.group) || An() }));
    ...
    ((vu = T({})),
      ...
      (Eu = {}),
      (Du = { x: `translateX`, y: `translateY`, z: `translateZ`, transformPerspective: `perspective` }),
      (Ou = Uc.length),
      (ku = (e) => (t, n) => {
        let r = _(vu),
          i = _(rs),
      ...
      (Au = () => ({ style: {}, transform: {}, transformOrigin: {}, vars: {} })),
      ...
      (Iu = { useVisualState: ku({ scrapeMotionValuesFromProps: _r, createRenderState: Au }) }),
      (Lu = { useVisualState: ku({ scrapeMotionValuesFromProps: vr, createRenderState: Nu }) }),
      (Ru = (e) => Array.isArray(e)),
      (zu = (e) => e !== null),
      (Bu = { type: `spring`, stiffness: 500, damping: 25, restSpeed: 10 }),
      (Vu = (e) => ({ type: `spring`, stiffness: 550, damping: e === 0 ? 2 * Math.sqrt(550) : 30, restSpeed: 10 })),
      ...
      (Gu =
        ...
        (o) => {
          ...
          let d = !1;
          if (
            ((u.type === !1 || (u.duration === 0 && !u.repeatDelay)) && ((u.duration = 0), u.delay === 0 && (d = !0)),
            (N.instantAnimations || N.skipAnimations) && ((d = !0), (u.duration = 0), (u.delay = 0)),
      ...
      (dd = class {
        ...
        forEach(e) {
          (this.isDirty && this.children.sort(ud), (this.isDirty = !1), this.children.forEach(e));
        }
      }),
      (fd = new WeakMap()),
      (pd = { current: null }),
      ...
      (gd = class {
        ...
        mount(e) {
          ((this.current = e),
            ...
            (this.shouldReduceMotion =
              this.reducedMotionConfig === `never` ? !1 : this.reducedMotionConfig === `always` ? !0 : pd.current),
            this.parent && this.parent.children.add(this),
        ...
        getValue(e, t) {
          ...
          let n = this.values.get(e);
          return (
            n === void 0 && t !== void 0 && ((n = E(t === null ? void 0 : t, { owner: this })), this.addValue(e, n)),
            n
          );
        }
        readValue(e, t) {
          ...
          return (
            n != null &&
              (typeof n == `string` && (ss(n) || cs(n)) ? (n = parseFloat(n)) : !nu(n) && K.test(t) && (n = Yt(e, t)),
        ...
        on(e, t) {
          return (this.events[e] || (this.events[e] = new fs()), this.events[e].add(t));
        }
        notify(e, ...t) {
        ...
        constructor(e, t, { transformPagePoint: n, contextWindow: r, dragSnapToOrigin: i = !1 } = {}) {
          if (
            ...
            (this.handlePointerUp = (e, t) => {
              ...
              let a = Si(
                e.type === `pointercancel` ? this.lastMoveEventInfo : bi(t, this.transformPagePoint),
                this.history,
              );
      ...
      (Cd = class {
        ...
        start(e, { snapToCursor: t = !1 } = {}) {
          ...
          let r = (e) => {
              ...
              (n ? this.pauseAnimation() : this.stopAnimation(), t && this.snapToCursor(Hr(e).point));
            },
            i = (e, t) => {
              ...
              if (
                n &&
                !r &&
                (this.openDragLock && this.openDragLock(), (this.openDragLock = en(n)), !this.openDragLock)
              )
                return;
              ((this.isDragging = !0),
                (this.currentDirection = null),
            ...
            a = (e, t) => {
              ...
              if (r && this.currentDirection === null) {
                ((this.currentDirection = Li(o)), this.currentDirection !== null && i && i(this.currentDirection));
                return;
              }
        ...
        updateAxis(e, t, n) {
          ...
          (this.constraints && this.constraints[e] && (a = Ei(a, this.constraints[e], this.elastic[e])), i.set(a));
        }
        resolveConstraints() {
          var e;
            ...
            i !== this.constraints &&
              ...
              k((e) => {
                this.constraints !== !1 &&
                  ...
                  (this.constraints[e] = Mi(r.layoutBox[e], this.constraints[e]));
              }));
        }
        ...
        startAxisValueAnimation(e, t) {
          ...
          return (Tr(this.visualElement, e), n.start(Gu(e, n, 0, t, this.visualElement, !1)));
        }
        stopAnimation() {
      ...
      (wd = class extends Q {
        constructor(e) {
          (super(e), (this.removeGroupControls = P), (this.removeListeners = P), (this.controls = new Cd(e)));
        }
        mount() {
      ...
      (Qd = { pan: { Feature: Ed }, drag: { Feature: wd, ProjectionNode: Zd, MeasureLayout: zi } }),
      ($d = class extends Q {
        mount() {
          let { current: e } = this.node;
          e && (this.unmount = rn(e, (e, t) => (ka(this.node, t, `Start`), (e) => ka(this.node, e, `End`))));
        }
        unmount() {}
      }),
      (ef = class extends Q {
      ...
      (tf = class extends Q {
        mount() {
          ...
          e &&
            (this.unmount = ln(
              e,
              (e, t) => (Aa(this.node, t, `Start`), (e, { success: t }) => Aa(this.node, e, t ? `End` : `Cancel`)),
      ...
      (lf = class extends Q {
        ...
        startObserver() {
          ...
          let { viewport: e = {} } = this.node.getProps(),
            ...
            a = { root: t ? t.current : void 0, rootMargin: n, threshold: typeof r == `number` ? r : cf[r] },
            o = (e) => {
      ...
      (uf = { inView: { Feature: lf }, tap: { Feature: tf }, focus: { Feature: ef }, hover: { Feature: $d } }),
      ...
      (pf = class extends ff {
        ...
        readValueFromInstance(e, t) {
          var n;
          if (Wc.has(t)) return (n = this.projection)?.isProjecting ? Et(t) : Hc(e, t);
          {
            let n = Fa(e),
      ...
      (gf = (e, t) => (hr(e) ? new hf(t) : new pf(t, { allowProjection: e !== C }))),
      ...
      (wf = () => ({ time: 0, x: Cf(), y: Cf() })),
      (Tf = { x: { length: `Width`, position: `Left` }, y: { length: `Height`, position: `Top` } }),
      ...
      (Pf = new Map()),
      (Ff = () => ({ scrollX: E(0), scrollY: E(0), scrollXProgress: E(0), scrollYProgress: E(0) })),
      (If = class extends zl {
        constructor() {
...
//# sourceMappingURL=motion.B5kiQUnY.mjs.map
